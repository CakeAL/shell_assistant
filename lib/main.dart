    ...
    return ChangeNotifierProvider.value(
      ...
      builder: (context, child) {
        ...
        return FluentApp(
          ...
          theme: FluentThemeData(accentColor: appTheme.color),
      ...
      builder: (context, constraints) {
        return NavigationView(
          titleBar: Container(
            ...
            child: Row(children: [Spacer(), Text('Welcome, $_userName')]),
          ),
          pane: NavigationPane(
        ...
        if (releaseInfo != null) {
          await showDialog<String>(
            ...
            builder: (context) => ContentDialog(
              title: Text(AppLocalizations.of(context)!.newVersionFound),
              content: Column(
              ...
              actions: [
                ...
                FilledButton(
                  child: Text(AppLocalizations.of(context)!.openReleasePage),
                  onPressed: () async {
