...
class _SystemScreenshotState extends State<SystemScreenshot> {
  ...
  bool _showsCursor = false;
  bool _captureHDR = false;
  ...
  Widget _secondCard() {
    List<String> formats = ['png', 'jpg', 'bmp', 'gif', 'pdf', 'tiff', 'heic'];
    return Card(
      child: InfoLabel(
      ...
      child: Column(
        ...
        children: [
          ToggleSwitch(
            ...
            content: Text(
              AppLocalizations.of(context)!.disabledScreenshotsShadow,
            ),
          ),
          ToggleSwitch(
          ...
          ToggleSwitch(
            checked: _showsCursor,
            onChanged: (v) {
              setState(() => _showsCursor = v);
              _updateCommand(
                6,
                'defaults write com.apple.screencapture showsCursor -bool $_showsCursor',
              );
            },
            content: Text(AppLocalizations.of(context)!.showsCursor),
          ),
          ToggleSwitch(
            checked: _captureHDR,
            onChanged: (v) {
              setState(() => _captureHDR = v);
              _updateCommand(
                7,
                'defaults write com.apple.screencapture captureHDR -bool $_captureHDR',
              );
            },
            content: Text(AppLocalizations.of(context)!.captureHDR),
          ),
        ],
      ),
    );
        ...
        SettingCard(
          writeSettings: () {
            final map = {
              ...
              6: _showsCursor.toString(),
              7: _captureHDR.toString(),
            };
            // print(map);
