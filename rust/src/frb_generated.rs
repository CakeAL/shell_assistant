...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 85902735;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        6 => wire__crate__api__command__init_app_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        3 => wire__crate__api__command__execute_reset_screenshot_settings_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        ...
        5 => wire__crate__api__command__execute_write_screenshot_settings_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
