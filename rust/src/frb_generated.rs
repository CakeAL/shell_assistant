...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 518255435;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        4 => wire__crate__api__command__init_app_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        1 => wire__crate__api__command__execute_bypass_signature_impl(ptr, rust_vec_len, data_len),
        2 => wire__crate__api__command__execute_reset_screenshot_settings_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        3 => wire__crate__api__command__execute_write_screenshot_settings_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
